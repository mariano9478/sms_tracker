...
class SettingsScreen extends StatelessWidget {
  ...
  void _showCommandReference(BuildContext context) {
    const rows = [
      ...
      ('Secuencia de llamadas SOS', 'SCS0 / SCS1'),
      ('Botón lateral → contacto n', 'X1'),
      ('Desactivar botón lateral', 'X0'),
      ('Sensor de caída', 'FL1,5,1'),
      ('Apagar sensor de caída', 'FL0'),
      ('Cerco virtual (1 y 2)', 'GEO1,1,0,100M'),
      ('Alerta de no movimiento', 'NMO1,80M,1'),
      ('Apagar no movimiento', 'NMO0'),
      ('Ubicación actual', 'loc'),
      ('Estado de batería', 'Battery'),
      ('Configuración actual', 'Status'),
      ('Hacer sonar', 'Findme'),
      ('Escucha remota on/off', 'LT1 / LT0'),
      ('Volumen timbre', 'rt50'),
      ('Volumen micrófono', 'micvolume10'),
      ('Volumen parlante', 'speakervolume90'),
      ('Parlante en llamadas SOS', 'sosspeaker1 / 0'),
      ('Llamadas entrantes (lista blanca)', 'callin1 / 0'),
      ('Voces del dispositivo', 'beep1 / 0'),
      ('Nombre del dispositivo', 'Prefix1,Mamá'),
      ('Zona horaria', 'TZ-03'),
